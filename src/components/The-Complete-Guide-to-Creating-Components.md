...
![image alt text](images/The-Complete-Guide-to-Creating-Components_0.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_1.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_2.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_3.png)
![image alt text](images/The-Complete-Guide-to-Creating-Components_4.png)
...
* **Avoid the !important _CSS tag**. Even though this could be the right choice in some cases, you might not want to use it on a component because it will override the developer's custom CSS, therefore, limiting customization.
...
**Reusability** and **simplicit** are key when creating a component. The component should be easy to understand, and it should focus on the main use cases. **Names**, **descriptions** and **visual cues**, such as **icons**, become fundamental to easily grasp the purpose of the component, and quickly know how to use it.
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_6.png)

![image alt text](images/The-Complete-Guide-to-Creating-Components_7.jpg)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_8.png)

* Check a **module's description**, by hovering in the **Manage Dependencies** popup window.
![image alt text](images/The-Complete-Guide-to-Creating-Components_9.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_10.png)
![image alt text](images/The-Complete-Guide-to-Creating-Components_11.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_12.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_13.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_14.png)

#### Action Icons

Setting image icons for actions helps to easily identify to which component an action belongs to in a flow.

![image alt text](images/The-Complete-Guide-to-Creating-Components_15.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_16.png)
...
Take a look at this example of the Silk Ui Mobile FloatingActions pattern. Its purpose if to provide a clickable circle that expands to provide extra options:

![image alt text](images/The-Complete-Guide-to-Creating-Components_17.png)

![image alt text](images/The-Complete-Guide-to-Creating-Components_18.gif)

#### servicestudio CSS Tags for a Better Development Experience
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_19.png)![image alt text](images/The-Complete-Guide-to-Creating-Components_20.png)
...
You should avoid using sample content for simple things like texts and images because it will only overwhelm and force the developer to delete them. Instead, add sample content only if it is mandatory or if it helps the developer.
 ...
 ![image alt text](images/The-Complete-Guide-to-Creating-Components_21.png)   ![image alt text](images/The-Complete-Guide-to-Creating-Components_22.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_23.png)
...
![image alt text](images/The-Complete-Guide-to-Creating-Components_24.png)
...
When using **external resources** (for example, external libraries, or JSON files), consider re-using them instead of re-fetching them. For example, the System's RequireScript action will use the cached file if you already requested it.
